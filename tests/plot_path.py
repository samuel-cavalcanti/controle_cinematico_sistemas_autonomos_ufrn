...
from utils import Position, deg2rad, euclidean_distance, rad2deg
...
def plot_position(initial_pos: Position, final_pos: Position):
    ...
    p_x, p_y, theta_t = path_by_polynomials.create_path_functions(x_coefficients=x_coefficients, y_coefficients=y_coefficients)

...
from path_planning.trajectory_follow import TrajectoryFollow
...
def main():
    ...
    while coppeliasim.simulation_is_alive(client_id):
        ...
        euler_angles_in_rads = coppeliasim.get_robot_orientation(
            client_id, pioneer)
    ...
    simulation_recorder.save(Path('main_path_follow.csv'))
